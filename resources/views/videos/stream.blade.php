                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <video id="my-video" class="video-js" controls preload="auto" width="1280" height="720"
                            data-setup="{}">
                            {{-- <source src="http://{{$_SERVER['SERVER_NAME']}}:8080/hls/mystream.m3u8"
                            type="application/x-mpegURL" res="9999" label="auto" /> --}}
                            <source src="/videos/video-2.mp4" type="video/mp4" res="9999" label="auto" />
